...
# These mappings preserve the old ``format=`` API. Only ieee/nature/elsevier
# correspond to source-backed modern families; the remaining names are
# explicitly unverified compatibility styles.
...
__all__ = ["LegacyStyleWarning", "PLOT_FORMATS"]
